...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var item = JSON.parse(btn.dataset.item); //to acces data value dataset used

    updateCart(item);
  });
}); //Remove Alert Message delay

var alertMsg = document.querySelector('#succes-alert');
...
__webpack_require__(/*! C:\Users\aksha\Desktop\online-clothing\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\aksha\Desktop\online-clothing\resources\scss\app.scss */"./resources/scss/app.scss");
